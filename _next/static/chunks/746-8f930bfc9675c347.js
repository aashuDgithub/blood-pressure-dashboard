        ...
        1957: function(t, e, n) {
                        ...
                        return new Proxy({
                            ...
                            get: (e, n, r) => eI(e, n, () => (function(e, n, r) {
                                ...
                                return tr(l) && u.isScriptable(n) && (l = function(t, e, n, r) {
                                    ...
                                    if (u.has(t)) throw Error("Recursion detected: " + Array.from(u).join("->") + "->" + t);
                                    u.add(t);
                                    let l = e(o, a || r);
                                    return u.delete(t), ej(t, l) && (l = eA(i._scopes, i, t, l)), l
                                }(n, l, e, r)), Y(l) && l.length && (l = function(e, n, r, i) {
                                    let {
                                        _proxy: o,
                                        _context: a,
                                        _subProxy: u,
                                    ...
                                    return n
                                }(n, l, e, u.isIndexable)), ej(n, l) && (l = t(l, o, a && a[n], u)), l
                            })(e, n, r)),
            ...
            function M(t) {
                ...
                let i = t.r / 255,
                    ...
                    l = Math.min(i, o, a),
                    c = (u + l) / 2;
                return u !== l && (r = u - l, n = c > .5 ? r / (2 - u - l) : r / (u + l), e = 60 * (e = i === u ? (o - a) / r + (o < a ? 6 : 0) : o === u ? (a - i) / r + 2 : (i - o) / r + 4) + .5), [0 | e, n || 0, c]
            }
            ...
            class E {
                        ...
                        o = t.length, "#" === t[0] && (4 === o || 5 === o ? i = {
                            ...
                            r || ((r = function() {
                                ...
                                for (t = 0; t < a.length; t++) {
                                    for (e = 0, r = i = a[t]; e < u.length; e++) n = u[e], i = i.replace(n, _[n]);
                ...
                rgbString() {
                    var t;
                    return this._valid ? (t = this._rgb) && (t.a < 255 ? `rgba(${t.r}, ${t.g}, ${t.b}, ${c(t.a)})` : `rgb(${t.r}, ${t.g}, ${t.b})`) : void 0
                }
                hexString() {
                    var t, e;
                ...
                hslString() {
                    return this._valid ? function(t) {
                        ...
                        let e = M(t),
                            ...
                            r = f(e[1]),
                            i = f(e[2]);
                        return t.a < 255 ? `hsla(${n}, ${r}%, ${i}%, ${c(t.a)})` : `hsl(${n}, ${r}%, ${i}%)`
                    }(this._rgb) : void 0
                }
                mix(t, e) {
                    if (t) {
                        ...
                        n = 1 - l, r.r = 255 & l * r.r + n * i.r + .5, r.g = 255 & l * r.g + n * i.g + .5, r.b = 255 & l * r.b + n * i.b + .5, r.a = o * r.a + (1 - o) * i.a, this.rgb = r
                    }
                    return this
                }
                interpolate(t, e) {
                ...
                rotate(t) {
                    var e, n;
                    return (n = M(e = this._rgb))[0] = O(n[0] + t), n = k(x, n, void 0, void 0), e.r = n[0], e.g = n[1], e.b = n[2], this
                }
            }
            ...
            function tZ(t, e, n) {
                ...
                if (t._sorted) {
                    ...
                    s && (i = tC(Math.min(tA(u, l, c).lo, n ? r : tA(e, l, a.getPixelForValue(c)).lo), 0, r - 1)), o = h ? tC(Math.max(tA(u, a.axis, f, !0).hi + 1, n ? 0 : tA(e, l, a.getPixelForValue(f), !0).hi + 1), i, r) - i : r - i
                }
                return {
                    start: i,
                    count: o
            ...
            let t3 = {
                ...
                numeric(t, e, n) {
                    ...
                    return Object.assign(l, this.options.ticks.format), t4(t, i, l)
                },
                logarithmic(t, e, n) {
            ...
            function eo(t, e, n, r) {
                let i, o, a, u, l;
                let c = (r = r || {}).data = r.data || {},
                    f = r.garbageCollect = r.garbageCollect || [];
                r.font !== e && (c = r.data = {}, f = r.garbageCollect = [], r.font = e), t.save(), t.font = e;
                let s = 0,
                    h = n.length;
                for (i = 0; i < h; i++)
                    if (null == (u = n[i]) || Y(u)) {
                        if (Y(u))
                            for (o = 0, a = u.length; o < a; o++) null == (l = u[o]) || Y(l) || (s = ei(t, c, f, s, l))
                    } else s = ei(t, c, f, s, u);
                t.restore();
                let d = f.length / 2;
                if (d > n.length) {
                    for (i = 0; i < d; i++) delete c[f[i]];
                    f.splice(0, d)
                }
                return s
            }
            ...
            function ec(t, e, n, r, i) {
                ...
                if (!isNaN(p) && !(p <= 0)) {
                    switch (t.beginPath(), d) {
                        default: i ? t.ellipse(n, r, i / 2, p, 0, 0, tu) : t.arc(n, r, p, 0, tu),
                        t.closePath();
                        break;
                        case "triangle":
                                f = i ? i / 2 : p,
                            t.moveTo(n + Math.sin(b) * f, r - Math.cos(b) * p),
                            b += td,
                            t.lineTo(n + Math.sin(b) * f, r - Math.cos(b) * p),
                            b += td,
                            t.lineTo(n + Math.sin(b) * f, r - Math.cos(b) * p),
                            t.closePath();
                            break;
                        case "rectRounded":
                                c = .516 * p,
                            a = Math.cos(b + th) * (l = p - c),
                            s = Math.cos(b + th) * (i ? i / 2 - c : l),
                            u = Math.sin(b + th) * l,
                            h = Math.sin(b + th) * (i ? i / 2 - c : l),
                            t.arc(n - s, r - u, c, b - ta, b - ts),
                            t.arc(n + h, r - a, c, b - ts, b),
                            t.arc(n + s, r + u, c, b, b + ts),
                            t.arc(n - h, r + a, c, b + ts, b + ta),
                            t.closePath();
                            break;
                        case "rect":
                                if (!g) {
                                l = Math.SQRT1_2 * p, f = i ? i / 2 : l, t.rect(n - f, r - l, 2 * f, 2 * l);
                                break
                            }b += th;
                        case "rectRot":
            ...
            function ep(t, e, n, r, i, o = {}) {
                ...
                for (t.save(), t.font = i.string, o.translation && t.translate(o.translation[0], o.translation[1]), F(o.rotation) || t.rotate(o.rotation), o.color && (t.fillStyle = o.color), o.textAlign && (t.textAlign = o.textAlign), o.textBaseline && (t.textBaseline = o.textBaseline), a = 0; a < l.length; ++a) u = l[a], o.backdrop && function(t, e) {
                        let n = t.fillStyle;
                        t.fillStyle = e.color, t.fillRect(e.left, e.top, e.width, e.height), t.fillStyle = n
                    }(t, o.backdrop), c && (o.strokeColor && (t.strokeStyle = o.strokeColor), F(o.strokeWidth) || (t.lineWidth = o.strokeWidth), t.strokeText(u, n, r, o.maxWidth)), t.fillText(u, n, r, o.maxWidth),
                    function(t, e, n, r, i) {
                        if (i.strikethrough || i.underline) {
                            ...
                            t.strokeStyle = t.fillStyle, t.beginPath(), t.lineWidth = i.decorationWidth || 2, t.moveTo(a, f), t.lineTo(u, f), t.stroke()
                        }
                    }(t, n, r, u, o), r += Number(i.lineHeight);
                t.restore()
            }
            ...
            function eO(t, e) {
                ...
                return i.string = !i || F(i.size) || F(i.family) ? null : (i.style ? i.style + " " : "") + (i.weight ? i.weight + " " : "") + i.size + "px " + i.family, i
            }

            function e_(t, e, n, r) {
                let i, o, a, u = !0;
                for (i = 0, o = t.length; i < o; ++i)
                    if (void 0 !== (a = t[i]) && (void 0 !== e && "function" == typeof a && (a = a(e), u = !1), void 0 !== n && Y(a) && (a = a[n % a.length], u = !1), void 0 !== a)) return r && !u && (r.cacheable = !1), a
            }
            ...
            function eS(t, e = [""], n, r, i = () => t[0]) {
                let o = n || t;
                return void 0 === r && (r = eF("_fallback", t)), new Proxy({
                    ...
                    get: (n, r) => eI(n, r, () => (function(t, e, n, r) {
                        let i;
                        for (let o of e)
                            if (void 0 !== (i = eF(eC(o, t), n))) return ej(t, i) ? eA(n, r, t, i) : i
                    })(r, e, t, n)),
            ...
            function eA(t, e, n, r) {
                ...
                let o = e._rootScopes,
                    ...
                    l = new Set;
                l.add(r);
                let c = eW(l, u, n, a || n, r);
                return null !== c && (void 0 === a || a === n || null !== (c = eW(l, u, a, c, r))) && eS(Array.from(l), [""], o, a, () => (function(t, e, n) {
                    let r = t._getTarget();
                    e in r || (r[e] = {});
                    let i = r[e];
                    return Y(i) && N(n) ? n : i || {}
            ...
            function eN(t, e, n, r) {
                ...
                let {
                    ...
                    key: l = "r"
                } = this._parsing, c = Array(r);
                for (i = 0; i < r; ++i) a = e[o = i + n], c[i] = {
                    r: u.parse(tt(a, l), o)
                };
                return c
            }
            ...
            function e$(t, e, n, r, i) {
                ...
                if (e.spanGaps && (t = t.filter(t => !t.skip)), "monotone" === e.cubicInterpolationMode) ! function(t, e = "x") {
                    ...
                    let o = eD(e),
                        ...
                        c = eL(t, 0);
                    for (n = 0; n < a; ++n)
                        if (r = i, i = c, c = eL(t, n + 1), i) {
                            if (c) {
                                let t = c[e] - i[e];
                                u[n] = 0 !== t ? (c[o] - i[o]) / t : 0
                            }
                            l[n] = r ? c ? tp(u[n - 1]) !== tp(u[n]) ? 0 : (u[n - 1] + u[n]) / 2 : u[n - 1] : u[n]
                        }! function(t, e, n) {
                        let r, i, o, a, u;
                        let l = t.length,
                            c = eL(t, 0);
                        for (let f = 0; f < l - 1; ++f)
                            if (u = c, c = eL(t, f + 1), u && c) {
                                if (tb(e[f], 0, eB)) {
                                    n[f] = n[f + 1] = 0;
                                    continue
                                }(a = Math.pow(r = n[f] / e[f], 2) + Math.pow(i = n[f + 1] / e[f], 2)) <= 9 || (o = 3 / Math.sqrt(a), n[f] = r * o * e[f], n[f + 1] = i * o * e[f])
                            }
                    }(t, u, l),
                    function(t, e, n = "x") {
                        let r, i, o;
                        let a = eD(n),
                            ...
                            l = eL(t, 0);
                        for (let c = 0; c < u; ++c) {
                            if (i = o, o = l, l = eL(t, c + 1), !o) continue;
                            let u = o[n],
                                f = o[a];
                            i && (r = (u - i[n]) / 3, o[`cp1${n}`] = u - r, o[`cp1${a}`] = f - r * e[c]), l && (r = (l[n] - u) / 3, o[`cp2${n}`] = u + r, o[`cp2${a}`] = f + r * e[c])
                        }
                    }(t, l, e)
                }(t, i);
                else {
                    let n = r ? t[t.length - 1] : t[0];
                    for (o = 0, a = t.length; o < a; ++o) l = function(t, e, n, r) {
                        let i = t.skip ? e : t,
                            o = n.skip ? e : n,
                            a = tT(e, i),
                            u = tT(o, e),
                    ...
                    }(n, u = t[o], t[Math.min(o + 1, a - (r ? 0 : 1)) % a], e.tension), u.cp1x = l.previous.x, u.cp1y = l.previous.y, u.cp2x = l.next.x, u.cp2y = l.next.y, n = u
                }
                e.capBezierPoints && function(t, e) {
                    let n, r, i, o, a;
                    let u = ef(t[0], e);
                    for (n = 0, r = t.length; n < r; ++n) a = o, o = u, u = n < r - 1 && ef(t[n + 1], e), o && (i = t[n], a && (i.cp1x = eH(i.cp1x, e.left, e.right), i.cp1y = eH(i.cp1y, e.top, e.bottom)), u && (i.cp2x = eH(i.cp2x, e.left, e.right), i.cp2y = eH(i.cp2y, e.top, e.bottom)))
                }(t, n)
            }
            ...
            function eU(t, e) {
                ...
                let {
                ...
                } = e, i = eZ(n), o = "border-box" === i.boxSizing, a = eV(i, "padding"), u = eV(i, "border", "width"), {
                    x: l,
                    y: c,
                    box: f
                } = function(t, e) {
                    ...
                    let i = t.touches,
                        ...
                        l = !1;
                    if (eK(a, u, t.target)) n = a, r = u;
                    else {
                        let t = e.getBoundingClientRect();
                        n = o.clientX - t.left, r = o.clientY - t.top, l = !0
                    }
                    return {
                        x: n,
                        y: r,
                ...
                }(t, n), s = a.left + (f && u.left), h = a.top + (f && u.top), {
                    width: d,
                    height: g
                } = e;
                return o && (d -= a.width + u.width, g -= a.height + u.height), {
            ...
            function eG(t, e, n, r) {
                let i = eZ(t),
                    o = eV(i, "margin"),
                    a = ez(i.maxWidth, t, "clientWidth") || tc,
                    u = ez(i.maxHeight, t, "clientHeight") || tc,
                    l = function(t, e, n) {
                        let r, i;
                        if (void 0 === e || void 0 === n) {
                            ...
                            if (o) {
                                let t = o.getBoundingClientRect(),
                                    ...
                                    u = eV(a, "border", "width"),
                                    l = eV(a, "padding");
                                e = t.width - l.width - u.width, n = t.height - l.height - u.height, r = ez(a.maxWidth, o, "clientWidth"), i = ez(a.maxHeight, o, "clientHeight")
                ...
                if ("content-box" === i.boxSizing) {
                    let t = eV(i, "border", "width"),
                        e = eV(i, "padding");
                    c -= e.width + t.width, f -= e.height + t.height
                }
                return c = Math.max(0, c - o.width), f = Math.max(0, r ? c / r : f - o.height), c = eJ(Math.min(c, a, l.maxWidth)), f = eJ(Math.min(f, u, l.maxHeight)), c && !f && (f = eJ(c / 2)), (void 0 !== e || void 0 !== n) && r && l.height && f > l.height && (c = eJ(Math.floor((f = l.height) * r))), {
                    width: c,
                    height: f
                }
            }
            ...
            function ne(t, e, n) {
                ...
                let {
                    ...
                    if (h) {
                        for (f += c, s += c, r = 0; r < c && u(l(e[f % c][i]), o, a); ++r) f--, s--;
                        f %= c, s %= c
                    }
                    return s < f && (s += c), {
                        start: f,
                ...
                }(t, e, n), y = [], m = !1, x = null, v = () => s(u, o, r) && 0 !== f(u, o), w = () => 0 === f(l, r) || s(l, o, r), M = () => m || v(), k = () => !m || w();
                for (let t = d, n = d; t <= g; ++t)(i = e[t % c]).skip || (r = h(i[a])) === o || (m = s(r, u, l), null === x && M() && (x = 0 === f(r, u) ? t : n), null !== x && k() && (y.push(nt({
                    start: x,
                    end: t,
                    loop: p,
                    count: c,
            ...
            function nr(t, e) {
                ...
                return ni(t, function(t, e, n, r) {
                    ...
                    for (i = e + 1; i <= n; ++i) {
                        let n = t[i % o];
                        n.skip || n.stop ? l.skip || (r = !1, a.push({
                            start: e % o,
                            end: (i - 1) % o,
                            loop: r
                        }), e = u = n.stop ? i : null) : (u = i, l.skip && (e = i)), l = n
                    }
                    ...
                    for (let t of e) {
                        ...
                        for (h = s + 1; h <= t.end; h++) {
                            ...
                            (function(t, e) {
                                ...
                                p1DataIndex: h % l,
                                datasetIndex: a
                            }))), f) && d(s, h - 1, t.loop, f), o = u, f = e
                        }
                        s < h - 1 && d(s, h - 1, t.loop, f)
                    }
                    return c
                }(t, e, n, r) : e
            }
        ...
        7346: function(t, e, n) {
            ...
            function c(t, e) {
                ...
                t.datasets = e.map(e => {
                    ...
                    return !i || !e.data || r.includes(i) ? { ...e
                    } : (r.push(i), Object.assign(i, e), i)
                })
            }
            let f = (0, o.forwardRef)(function(t, e) {
                    let {
                        height: n = 150,
                        width: r = 300,
                        redraw: i = !1,
                        ...
                        updateMode: b,
                        ...y
                    } = t, m = (0, o.useRef)(null), x = (0, o.useRef)(), v = () => {
                        m.current && (x.current = new a.kL(m.current, {
                            type: s,
                            data: function(t) {
                                var e;
                                let n = arguments.length > 1 && void 0 !== arguments[1] ? arguments[1] : u,
                                    r = {
                                        labels: [],
                                        datasets: []
                                    };
                                return e = t.labels, r.labels = e, c(r, t.datasets, n), r
                            }(h, f),
                            options: d && { ...d
                            },
                            plugins: g
                        ...
                        l(e, null), x.current && (x.current.destroy(), x.current = null)
                    };
                    return (0, o.useEffect)(() => {
                        !i && x.current && d && function(t, e) {
                            let n = t.options;
                    ...
                    }, [i, h.labels]), (0, o.useEffect)(() => {
                        !i && x.current && h.datasets && c(x.current.config.data, h.datasets, f)
                    }, [i, h.datasets]), (0, o.useEffect)(() => {
                        x.current && (i ? (w(), setTimeout(v)) : x.current.update(b))
                    }, [i, d, h.labels, h.datasets, b]), (0, o.useEffect)(() => {
                        x.current && (w(), setTimeout(v))
                    }, [s]), (0, o.useEffect)(() => (v(), () => w()), []), o.createElement("canvas", Object.assign({
                        ref: m,
                        role: "img",
                        height: n,
                        width: r
                ...
                s = (r = "line", i = a.ST, a.kL.register(i), (0, o.forwardRef)((t, e) => o.createElement(f, Object.assign({}, t, {
                    ref: e,
                    type: r
                }))))
        }
